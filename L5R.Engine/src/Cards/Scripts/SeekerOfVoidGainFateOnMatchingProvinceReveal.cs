...
/// <summary>seeker-of-void: same shape as SeekerOfAirGainFateOnMatchingProvinceReveal, gated on the void trait instead.</summary>
public sealed class SeekerOfVoidGainFateOnMatchingProvinceReveal : ICardScript
{
    public void Execute(AbilityContext context)
    {
        ...
        if (!revealedProvince.Traits.Contains("void"))
            throw new InvalidOperationException($"'{revealedProvince.Id}' must be a void province.");
